...
|DNS_PROVIDER|digitalocean|This is the value provided to the ACME DNS Challenge and is also used to build the DNS Provider mod. It needs to be set in the [docker-compose.yml]('github.com/SamEureka/balenaCaddyReverser/blob/main/docker-compose.yml') and set as a device variable. |
